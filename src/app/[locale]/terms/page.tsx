...
export async function generateMetadata({
  ...
  return {
    title: `${t("termsTitle")} - FiveM Viewer`,
  };
}
...
const Terms = async ({ params }: { params: Promise<{ locale: string }> }) => {
  try {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 relative">
        ...
        <div className="max-w-3xl mx-auto p-6">
          ...
          <p className="text-zinc-400 mb-4">{t("termsWelcome")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            1. {t("termsSiteUsage")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsSiteUsageDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
          ...
          <p className="text-zinc-400 mb-4">{t("termsFiveMDataDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            3.1 {t("termsRockstarPosition")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsRockstarPositionDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
          ...
          <p className="text-zinc-400 mb-4">{t("termsDataProtectionDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            7. {t("termsCookies")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsCookiesDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            8. {t("termsModifications")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsModificationsDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            9. {t("termsApplicableLaw")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsApplicableLawDesc")}</p>
          <h2 className="text-2xl font-semibold text-zinc-300 mt-8 mb-4 border-b border-zinc-700 pb-2">
            10. {t("termsContact")}
          </h2>
          <p className="text-zinc-400 mb-4">{t("termsContactDesc")}</p>
    ...
    return (
      <div className="p-20 text-red-500 bg-white overflow-auto">
